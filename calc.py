...
button_equal = Button(root, text="=", padx=98, pady = 20, command=button_equal, fg='blue')
button_clear = Button(root, text="Clear", padx=86, pady = 20, command=button_clear, fg='blue')


button_add = Button(root, text="+", padx=39, pady = 20, command=button_add, fg='blue')
button_subtract = Button(root, text="-", padx=41, pady = 20, command=button_subtract, fg='blue')
button_multiply = Button(root, text="x", padx=40, pady = 20, command=button_multiply, fg='blue')
