...
button_subtract = Button(root, text="+", padx=39, pady = 20, command=button_subtract, fg='blue')
button_multiply = Button(root, text="+", padx=39, pady = 20, command=button_multiply, fg='blue')
button_divide = Button(root, text="+", padx=39, pady = 20, command=button_divide, fg='blue')
